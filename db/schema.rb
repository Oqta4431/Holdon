...
ActiveRecord::Schema[7.2].define(version: 2026_05_05_083139) do
  ...
  create_table "past_reminders", force: :cascade do |t|
    t.bigint "reminder_id", null: false
    t.datetime "past_remind_at", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reminder_id"], name: "index_past_reminders_on_reminder_id"
  end
  ...
  create_table "reasons", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_reasons_on_item_id", unique: true
  end
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_reviews_on_item_id", unique: true
  end
  ...
  add_foreign_key "past_reminders", "reminders"
  add_foreign_key "reasons", "items"
